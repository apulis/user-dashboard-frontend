...
export default {
  // List
  'roles.list.name': 'Role Name',
  'roles.list.description': 'Description',
  ...
  'roles.list.modal.confim.delete.role': 'Will delete current selected role?',
  'roles.list.message.success': 'Success',
  'roles.list.create.role': 'Create Role',
