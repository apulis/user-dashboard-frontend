...
import findRoute, {
  getUrlQuery,
} from '/Users/hanzelin/Desktop/apulis/addon_custom_user_group_dashboard/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3002,
      path: '/Users/hanzelin/Desktop/apulis/addon_custom_user_group_dashboard',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
