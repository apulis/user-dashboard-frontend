export default {
  ...
  'user-register.login.password2': 'Confirm Password',
  ...
  'user-register.login.tab-register-credentials': 'Credentials',
  'user-register.login.tab-register-mobile': 'Mobile number',
  ...
  'user-register.password2.required': 'Please confirm your password!',
