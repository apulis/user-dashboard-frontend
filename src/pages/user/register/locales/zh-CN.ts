export default {
  ...
  'user-register.login.tab-register-credentials': '账户密码',
  'user-register.login.tab-register-mobile': '手机号登录',
  ...
  //
  'user-register-tab-account-register': '注册账户',
  'user-register.register.register-with': '其他注册方式',
  'user-register.register.register': '注册',
  'user-register.register.nickName': '昵称',
  'user-register.nickName.required': '请输入昵称!',
  'user-register.register.sign-up-with': '注册方式',
